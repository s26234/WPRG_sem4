<html>
<head>
<title>ReservationPlusExtraForm</title>
      <?php
    function two() {

        ?>
        ?>
        <form action="cw2_3.php" method="post">
...
<form>
    <form action="" method="post">
        <label for="ppl">Select number people in room</label>
        ...
        <select id="room_pref" name="room_pref" required>
            <option disabled selected value="">--</option>
            <option value="Smoking">Allow to smoke</option>
            <option value="Kid">Design especially for family with kids</option>
            <option value="Animal">Allow to come with animal</option>
        </select>
